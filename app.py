...
def load_data(uploaded_file):
    ...
    try:
        ...
        # ==========================================================================
        # ==         THE FINAL FIX: "LAUNDER" THE DATAFRAME                   ==
        # == Re-create the DataFrame from its raw values to strip hidden metadata ==
        # ==========================================================================
...
def run_backtest(price_df, indicators_df, sectors, benchmark_col, weights, top_n=2):
    ...
    latest_scores = pd.Series(dtype=float) # Initialize
    ...
    for i in range(len(rebalancing_dates) - 1):
        ...
        latest_scores = sector_scores # Store the last calculated scores
